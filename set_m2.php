...
<?php
    ...
    $sql = "SELECT * FROM milestones_table WHERE milestone_no = '2'";
                            ...
                            <div class="col">
                                <div style="border-radius: 25PX;">
                                    <div style="background: #fe4a49;border-radius: 15px;">
                                        <div style="background: url(&quot;assets/img/achievement.png&quot;) center / contain no-repeat, #ffffff;height: 111px;border-style: solid;border-radius: 120PX;width: 110px;margin: 20px;padding: 1px;margin-left: 505px;"></div>
